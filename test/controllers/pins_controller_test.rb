...
class PinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pin" do
    assert_difference('Pin.count') do
      post pins_url, params: { pin: { lat: @pin.lat, long: @pin.long, name: @pin.name, popup: @pin.popup, text: @pin.text } }
    end
  ...
  test "should update pin" do
    patch pin_url(@pin), params: { pin: { lat: @pin.lat, long: @pin.long, name: @pin.name, popup: @pin.popup, text: @pin.text } }
